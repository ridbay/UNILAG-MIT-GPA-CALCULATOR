...
// ../.wrangler/tmp/bundle-xcyHnj/checked-fetch.js
...
// api/results/[matricNumber].ts
var onRequestGet = /* @__PURE__ */ __name(async (context) => {
  const { env, params } = context;
  const matricNumber = params.matricNumber;
  if (!matricNumber) {
...
// ../.wrangler/tmp/pages-HAAsS1/functionsRoutes-0.11290310310779805.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-xcyHnj/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-xcyHnj/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.41975450157863947.mjs.map
